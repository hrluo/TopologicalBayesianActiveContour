...
% Hausdorff Distance
% version 1.6.0.0 (4.22 KB) by Zachary Danziger
% Calculates the Hausdorff Distance between two sets of points P and Q in a 
...
% Outputs:
% hd = Hausdorff distance between two sets P,Q.
% D = distance matrix between pairwise points in P,Q.
